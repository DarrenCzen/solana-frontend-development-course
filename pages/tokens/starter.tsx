...
const Starter = () => {
    ...
    const [mintAddr, setMintAddr] = useState<web3.PublicKey | undefined>(undefined);
    ...
    const createMint = async (event: { preventDefault: () => void }) => {
        ...
        if (!isWalletConnected()) throw Constants.TEXT_CONNECT_WALLET;
        ...
        const transaction = new web3.Transaction().add(
            ...
            token.createInitializeMintInstruction(tokenMint.publicKey, 0, publicKey!, token.TOKEN_PROGRAM_ID),
        );
    ...
    const createAccount = async (event: { preventDefault: () => void }) => {
        ...
        const transaction = new web3.Transaction().add(
            ...
            token.createInitializeAccountInstruction(tokenAccount.publicKey, mintAddr!, publicKey!, token.TOKEN_PROGRAM_ID),
        );
