...
const Starter = () => {
    ...
    const createSubmission = async (event: { preventDefault: () => void }) => {
        ...
        await handleTransactionSubmission(studentIntro);
    };

    const handleTransactionSubmission = async (studentIntro: StudentIntro) => {
        ...
        //program derived address - an account that is associated with a program that is created for the user
